...
class ActiveQuery extends \yii\db\ActiveQuery
{
     ...
     * @param null $db
     * @return array|void|ActiveRecord|null Экземпляр ActiveRecord модели
     * @throws DbException
     */
    public function one($db = null)
    {
        ...
        // TODO надо что-то придумывать, это явный костыль
    ...
    public function first($db = null)
    {
        ...
        if(!sizeof($rows)) {
            throw new DbException('no rows found for first', DbException::STATUS_EMPTY_RESULT);
        }
